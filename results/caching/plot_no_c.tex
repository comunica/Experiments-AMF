...
\pgfplotsset{
  /pgfplots/bar cycle list/.style={/pgfplots/cycle list={%
        {dotted,fill=Goldenrod,mark=none}, {solid,fill=VioletRed,mark=none}, {dotted,fill=Yellow,mark=none}, {solid,fill=White,mark=none}, 
    }
  },
}
...
\legend{HTTP+Filter,Filter,HTTP,None}
\end{resultAxis}
\end{tikzpicture}
\end{document}
