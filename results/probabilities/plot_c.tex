...
\begin{tikzpicture}
\begin{resultAxis}
\addplot+[ybar] table [x=query, y expr=\thisrow{combination_0} / 1000, col sep=semicolon]{"plot_c.csv"}; \addplot+[ybar] table [x=query, y expr=\thisrow{combination_2} / 1000, col sep=semicolon]{"plot_c.csv"}; \addplot+[ybar] table [x=query, y expr=\thisrow{combination_4} / 1000, col sep=semicolon]{"plot_c.csv"}; \addplot+[ybar] table [x=query, y expr=\thisrow{combination_6} / 1000, col sep=semicolon]{"plot_c.csv"}; \addplot+[ybar] table [x=query, y expr=\thisrow{combination_7} / 1000, col sep=semicolon]{"plot_c.csv"}; 
