...
\begin{tikzpicture}
\begin{resultAxis}
\addplot+[ybar] table [x=query, y expr=\thisrow{combination_0} / 1000, col sep=semicolon]{"plot_no_c.csv"}; \addplot+[ybar] table [x=query, y expr=\thisrow{combination_2} / 1000, col sep=semicolon]{"plot_no_c.csv"}; \addplot+[ybar] table [x=query, y expr=\thisrow{combination_4} / 1000, col sep=semicolon]{"plot_no_c.csv"}; \addplot+[ybar] table [x=query, y expr=\thisrow{combination_6} / 1000, col sep=semicolon]{"plot_no_c.csv"}; \addplot+[ybar] table [x=query, y expr=\thisrow{combination_7} / 1000, col sep=semicolon]{"plot_no_c.csv"}; 
\legend{1/4096,1/1024,1/64,1/4,1/2}
\end{resultAxis}
\end{tikzpicture}
\end{document}
